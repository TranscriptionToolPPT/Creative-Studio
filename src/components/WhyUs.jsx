    ...
    <div className="grid gap-6 md:grid-cols-2">
      ...
      >
        ...
        <div className="mt-6 space-y-3">
          {items.map((x) => (
            <div key={x} className="flex items-start gap-3 text-slate-800">
        ...
        <div className="relative">
          ...
          <div className="mt-6 grid gap-3">
            <div className="glass rounded-2xl p-4">
              ...
              <div className="text-xs text-slate-600 mt-1">Clean landing page + deploy-ready build.</div>
            </div>
            <div className="glass rounded-2xl p-4">
              <div className="text-sm font-bold">Easy Editing</div>
              <div className="text-xs text-slate-600 mt-1">Update brand/phone/email in one file.</div>
            </div>
            <div className="glass rounded-2xl p-4">
              <div className="text-sm font-bold">Modern Animations</div>
              <div className="text-xs text-slate-600 mt-1">Smooth motion without being heavy.</div>
            </div>
          </div>
        </div>
      </motion.div>
