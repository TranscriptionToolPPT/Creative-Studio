  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      ...
      >
        ...
        <p className="mt-2 text-slate-700/85">
          Premium design, clean implementation, and a smooth experience from idea to launch.
        </p>

        <div className="mt-6 space-y-3">
          {items.map((x) => (
            <div key={x} className="flex items-start gap-3 text-slate-700">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-sky-500/16 via-teal-500/12 to-indigo-400/10" />
        <div className="relative">
          ...
          <div className="mt-6 grid gap-3">
            <div className="glass rounded-2xl p-4">
              ...
              <div className="text-xs text-slate-500/80 mt-1">Clean landing page + deploy-ready build.</div>
            </div>
            <div className="glass rounded-2xl p-4">
              <div className="text-sm font-bold">Easy Editing</div>
              <div className="text-xs text-slate-500/80 mt-1">Update brand/phone/email in one file.</div>
            </div>
            <div className="glass rounded-2xl p-4">
              <div className="text-sm font-bold">Modern Animations</div>
              <div className="text-xs text-slate-500/80 mt-1">Smooth motion without being heavy.</div>
            </div>
          </div>
        </div>
      </motion.div>
