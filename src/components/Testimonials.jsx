      ...
      {TESTIMONIALS.map((t, idx) => (
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="text-xs text-violet-200/55">★★★★★</div>
          </div>
          <blockquote className="mt-5 text-violet-100 leading-relaxed">“{t.quote}”</blockquote>
          <figcaption className="mt-6 text-sm">
            <div className="font-extrabold">{t.name}</div>
            <div className="text-violet-200/70">{t.company}</div>
          </figcaption>
        </motion.figure>
      ))}
    </div>
