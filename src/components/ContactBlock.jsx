    ...
    >
      <div className="lg:col-span-5">
        <div className="card relative overflow-hidden h-full">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 via-cyan-400/10 to-emerald-400/10" />
          <div className="relative">
            ...
            <div className="mt-8 grid gap-3">
              <div className="glass rounded-2xl p-4">
                ...
                <div className="mt-2 text-slate-100/85">{SITE.phoneDisplay}</div>
              </div>
              <div className="glass rounded-2xl p-4">
                <div className="flex items-center gap-2 text-sm font-bold"><Mail size={16} /> Email</div>
                <div className="mt-2 text-slate-100/85">{SITE.email}</div>
              </div>
            </div>

            <div className="mt-8 text-xs text-slate-400/60">
      ...
      <div className="lg:col-span-7">
        <div className="card">
          ...
          <p className="mt-2 text-slate-100/85">No backend needed — it opens your email client with the details.</p>
