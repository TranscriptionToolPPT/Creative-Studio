        ...
        <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-7">
            ...
            <motion.p
              ...
              className="mt-5 text-violet-100/80 max-w-2xl"
            >
            ...
            <p className="mt-5 text-sm text-violet-200/80">Trusted by growing teams across multiple industries.</p>
          </div>
              ...
              <div className="relative">
                ...
                <div className="mt-5 grid gap-3">
                  {[
                    ...
                    <div key={item} className="glass rounded-2xl p-4 text-violet-100/85">{item}</div>
                  ))}
                </div>
              </div>
            </div>
